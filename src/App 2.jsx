...
const T = {
  en: {
    ...
    q6: "DO YOU HAVE ANY PRIOR MARRIAGES THAT ENDED?", q7: "HAVE YOU EVER HAD A LEGAL NAME CHANGE?", q8: "HAVE YOU SERVED IN THE U.S. MILITARY?",
  ...
  es: {
    ...
    q6: "¿TIENES MATRIMONIOS ANTERIORES QUE HAYAN TERMINADO?", q7: "¿HAS TENIDO UN CAMBIO LEGAL DE NOMBRE?", q8: "¿HAS SERVIDO EN LAS FUERZAS ARMADAS DE EE.UU.?",
  ...
  zh: {
    ...
    q6: "您有过以前结束的婚姻吗？", q7: "您是否曾经合法更名？", q8: "您是否在美国军队服役过？",
  ...
  tl: {
    ...
    q6: "MAYROON KA BANG MGA NAKARAANG KASAL NA NATAPOS?", q7: "NAKARANAS KA NA BA NG LEGAL NA PAGPAPALIT NG PANGALAN?", q8: "NAGSILBI KA BA SA HUKBO NG U.S.?",
  ...
  vi: {
    ...
    q6: "BẠN CÓ CÁC HÔN NHÂN TRƯỚC ĐÃ KẾT THÚC KHÔNG?", q7: "BẠN CÓ TỪNG THAY ĐỔI TÊN HỢP PHÁP KHÔNG?", q8: "BẠN CÓ TỪNG PHỤC VỤ TRONG QUÂN ĐỘI HOA KỲ KHÔNG?",
  ...
  hi: {
    ...
    q6: "क्या आपकी कोई पिछली शादियाँ समाप्त हुई हैं?", q7: "क्या आपने कभी कानूनी नाम परिवर्तन किया है?", q8: "क्या आपने अमेरिकी सेना में सेवा की है?",
  ...
  ko: {
    ...
    q6: "종료된 이전 결혼이 있나요?", q7: "법적 이름 변경을 한 적이 있나요?", q8: "미국 군대에서 복무한 적이 있나요?",
  ...
  pt: {
    ...
    q6: "VOCÊ TEM CASAMENTOS ANTERIORES QUE TERMINARAM?", q7: "VOCÊ JÁ TEVE UMA MUDANÇA LEGAL DE NOME?", q8: "VOCÊ JÁ SERVIU NAS FORÇAS ARMADAS DOS EUA?",
...
// SoftwareApplication Schema — injected once on mount for Google AI Overviews
  ...
  const generateRisk = async () => {
    setLoadingAI(true);
    try {
      const text = await callAI(`You are an expert immigration preparation assistant. Based on these N-400 applicant answers: ${JSON.stringify(onboardingAnswers)}, identify 3-5 personal risk factors that could affect their citizenship application. Consider: travel history over 6 months, criminal record, prior marriages requiring divorce decrees, military service pathways, name change documentation gaps, tax compliance, continuous residence. Be specific to their answers. IMPORTANT: Respond ENTIRELY in ${langName}. Return ONLY a valid JSON array with no markdown or extra text: [{"title":"...","explanation":"...","action":"..."}]`);
    ...
    return (
      <div style={{ minHeight:"100vh",background:"#000",fontFamily:"'Cormorant Garamond',serif",paddingTop:"80px" }}>
        ...
        <div style={{ height:"3px",background:"#111",position:"fixed",top:"80px",left:0,right:0,zIndex:99 }}>
          <div style={{ height:"100%",background:"#C9A84C",width:`${(currentQ/8)*100}%`,transition:"width 0.5s ease" }} />
        </div>
        <div style={{ display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"calc(100vh - 80px)",padding:"40px" }}>
          <p style={{ color:"#666",fontSize:"11px",letterSpacing:"5px",marginBottom:"48px" }}>QUESTION {currentQ+1} OF 8</p>
          ...
          <div style={{ display:"flex",flexDirection:"column",gap:"2px",marginBottom:"56px",textAlign:"left" }}>
            ...
            <div style={{ background:"#0d0d0d",border:"1px solid #222",borderLeft:"3px solid #C9A84C",padding:"28px 32px",display:"flex",gap:"24px",alignItems:"flex-start" }}>
              ...
              <div>
                ...
                <p style={{ color:"#aaa",fontSize:"13px",lineHeight:1.8,margin:0 }}>Can't afford the fee? You may qualify for a <a href="/n-400-fee-waiver.html" target="_blank" style={{color:"#C9A84C"}}>full fee waiver ($0) or reduced fee ($380)</a> based on income or benefits you receive.</p>
              </div>
            </div>
            <div style={{ background:"#0d0d0d",border:"1px solid #222",borderLeft:"3px solid #C9A84C",padding:"28px 32px",display:"flex",gap:"24px",alignItems:"flex-start" }}>
